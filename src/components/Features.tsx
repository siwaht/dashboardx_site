        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 lg:gap-6">
            {additionalFeatures.map((feature, index) => (
              <div
                key={index}
                className="scroll-reveal flex items-start gap-4 sm:gap-5 bg-light-primary/95 dark:bg-dark-primary/95 p-5 sm:p-6 md:p-7 rounded-2xl border border-brand-slate-200/20 dark:border-brand-slate-700/20 hover:border-brand-purple dark:hover:border-brand-pink transition-all duration-300 shadow-elevation-2"
              >
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-brand-violet via-brand-purple to-brand-pink flex items-center justify-center flex-shrink-0 shadow-elevation-2 border-2 border-white/20">
