...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 py-4 md:py-5 lg:py-6 bg-light-primary/95 dark:bg-dark-primary/95 backdrop-blur-xl border-b border-brand-slate-light/20 dark:border-brand-slate/20 transition-all duration-300 shadow-elevation-1">
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        <nav className="flex justify-between items-center gap-4">
          <a
            href="#"
            className="font-display text-2xl md:text-3xl font-bold text-gradient transition-all hover:scale-105 inline-block duration-500 flex-shrink-0"
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            >
              {mobileMenuOpen ? (
                <X className="w-6 h-6 text-brand-coral-mid" />
              ) : (
                <Menu className="w-6 h-6 text-brand-teal-mid" />
              )}
            </button>
          </div>
        </nav>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 py-4 border-t border-brand-slate-light/20 dark:border-brand-slate/20 animate-fadeInUp bg-light-secondary/30 dark:bg-dark-secondary/30 rounded-b-2xl">
            <ul className="flex flex-col gap-2">
              <li>
                <a
                  href="#services"
                  className="block py-2.5 text-base text-text-light-secondary dark:text-text-dark-secondary font-bold hover:text-gradient transition-all duration-500 hover:pl-2"
              ...
              <li className="mt-2">
                <a
                  href="#demo-form"
                  className="block text-center bg-gradient-brand text-white px-6 py-3 rounded-full font-bold hover:shadow-glow-lg hover:scale-105 transition-all duration-500 min-h-[44px] shadow-elevation-2 border-2 border-white/20"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Request Demo
                </a>
