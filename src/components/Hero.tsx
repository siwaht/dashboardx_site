      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="scroll-reveal text-base sm:text-lg md:text-xl text-text-light-secondary dark:text-text-dark-secondary max-w-3xl mx-auto mb-8 md:mb-12 leading-relaxed px-4 font-medium" style={{ animationDelay: '0.2s' }}>
            Comprehensive AI solutions designed to automate, enhance, and transform every aspect of your business operations—now including personalized agents and marketing solutions. Available 24/7, powered by your data, and seamlessly integrated.
          </p>
