      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 px-4">
            <h2 id="workflow-heading" className="font-display text-4xl md:text-5xl font-bold mb-6 text-text-light-primary dark:text-text-dark-primary tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12 px-4">
            <div className="scroll-reveal bg-light-secondary/50 dark:bg-dark-secondary/50 p-6 rounded-xl border border-border-light dark:border-border-dark">
            ...
            <div className="scroll-reveal bg-light-secondary/50 dark:bg-dark-secondary/50 p-6 rounded-xl border border-border-light dark:border-border-dark" style={{ animationDelay: '0.1s' }}>
              <h3 className="text-xl font-bold mb-3 text-text-light-primary dark:text-text-dark-primary">
